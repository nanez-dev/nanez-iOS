...
class TabController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let vc3 = UINavigationController(rootViewController: MyInfoViewController(viewModel: MyInfoViewModel(myInfoUseCase: MyInfoUseCase(repository: MyInfoRepository(myInfoService: MyInfoService())))))
